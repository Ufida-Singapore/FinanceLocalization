...
public class CMPAgiotageVO extends nc.vo.pub.ValueObject {
	...
	public static int getMode(String dwbm, Integer system) {
		...
		String mode = nc.vo.ml.NCLangRes4VoTransl.getNCLangRes().getStrByID("3607agi_0","03607agi-0055")/*@res "月末计算"*/;
		try {
		...
		if (mode.equals(nc.vo.ml.NCLangRes4VoTransl.getNCLangRes().getStrByID("3607agi_0","03607agi-0055")/*@res "月末计算"*/)) /*-=notranslate=-*/
			smode = CMPAgiotageVO.AGIOTAGE_END;
		else if (mode.equals(nc.vo.ml.NCLangRes4VoTransl.getNCLangRes().getStrByID("3607agi_0","03607agi-0056")/*@res "计算已实现汇兑损益"*/)) /*-=notranslate=-*/
	...
	private Vector<CMPAgiotageBzVO> m_sSelBzbm; /* 用户选中的币种编码组 */
	private Hashtable m_pkAccids;/* 币种对应的账户 */
	private Hashtable m_pkManageAccids;/* 币种对应的管理账户 */
	...
	private CMPJe m_CalCe;/* 计算汇兑损益的差额 */
	...
	public Hashtable<String, String> getAllBz() throws BusinessException {
		if (allBz == null && m_sDwbm != null) {
			try {
				...
				throw new BusinessException(nc.vo.ml.NCLangRes4VoTransl.getNCLangRes().getStrByID("3607agi_0","03607agi-0057")/*@res "查询币种信息出错:"*/
						+ e.getMessage(), e);
			}
		}
		return allBz;
	...
	/**
	 * 主要功能： 主要算法： 异常描述： 创建日期：(2001-8-8 11:02:51) 最后修改日期：(2001-8-8 11:02:51)
	 *
	 * @author：wyan
	...
	/**
	 * 主要功能： 主要算法： 异常描述： 创建日期：(2001-8-8 11:13:29) 最后修改日期：(2001-8-8 11:13:29)
	 *
	 * @author：wyan
	 * @return java.lang.String
	 */
	...
	/**
	 * 此处插入方法描述。 创建日期：(2003-9-29 13:28:43)
	 *
	...
	/**
	 * 主要功能： 主要算法： 异常描述： 创建日期：(2001-8-8 10:26:57) 最后修改日期：(2001-8-8 10:26:57)
	 *
	 * @author：wyan
	 * @return java.lang.String
	 */
	...
	/**
	 * 主要功能： 主要算法： 异常描述： 创建日期：(2001-8-10 14:03:03) 最后修改日期：(2001-8-10 14:03:03)
	 *
	 * @author：wyan
	 * @return java.lang.String
	 */
	...
	/**
	 * 主要功能： 主要算法： 异常描述： 创建日期：(2001-8-10 15:33:03) 最后修改日期：(2001-8-10 15:33:03)
	 *
	 * @author：wyan
	 * @return java.lang.String
	 */
	...
	/**
	 * 主要功能： 主要算法： 异常描述： 创建日期：(2001-8-10 14:10:46) 最后修改日期：(2001-8-10 14:10:46)
	 *
	 * @author：wyan
	 * @return java.lang.String
	 */
	...
	/**
	 * 主要功能： 主要算法： 异常描述： 创建日期：(2001-8-10 14:09:31) 最后修改日期：(2001-8-10 14:09:31)
	 *
	 * @author：wyan
	 * @return java.lang.String
	 */
	...
	/**
	 * 主要功能： 主要算法： 异常描述： 创建日期：(2001-8-10 14:10:08) 最后修改日期：(2001-8-10 14:10:08)
	 *
	 * @author：wyan
	 * @return java.lang.String
	 */
	...
	/**
	 * 主要功能： 主要算法： 异常描述： 创建日期：(2001-8-10 14:05:49) 最后修改日期：(2001-8-10 14:05:49)
	 *
	 * @author：wyan
	 * @return java.lang.String
	 */
	...
	/**
	 * 主要功能： 主要算法： 异常描述： 创建日期：(2001-8-8 11:01:26) 最后修改日期：(2001-8-8 11:01:26)
	 *
	 * @author：wyan
	 * @return java.lang.String
	 */
	...
	/**
	 * a功能: 作者：wyan 创建时间：(2002-5-14 11:26:24) 参数：<|> 返回值： 算法：
	 *
	 * @return java.lang.String
	 */
	...
	/**
	 * 此处插入方法说明。 创建日期：(2001-11-6 16:52:40)
	 *
	 * @return boolean
	 */
	...
	/**
	 * 主要功能： 主要算法： 异常描述： 创建日期：(2001-8-10 16:22:31) 最后修改日期：(2001-8-10 16:22:31)
	 *
	 * @author：wyan
	 * @return java.lang.String
	 */
	...
	// }
	/**
	 * 主要功能： 主要算法： 异常描述： 创建日期：(2001-8-8 10:26:11) 最后修改日期：(2001-8-8 10:26:11)
	 *
	 * @author：wyan
	...
	/**
	 * a功能: 作者：wyan 创建时间：(2002-5-14 11:28:21) 参数：<|> 返回值： 算法：
	 *
	 * @return java.lang.String
	 */
	...
	/**
	 * 主要功能： 主要算法： 异常描述： 创建日期：(2001-8-10 14:12:22) 最后修改日期：(2001-8-10 14:12:22)
	 *
	 * @author：wyan
	 * @return java.lang.String
	 */
	...
	/**
	 * 主要功能： 主要算法： 异常描述： 创建日期：(2001-8-10 14:12:07) 最后修改日期：(2001-8-10 14:12:07)
	 *
	 * @author：wyan
	 * @return java.lang.String
	 */
	...
	/**
	 * 此处插入方法描述。 创建日期：(2003-9-28 13:49:39)
	 *
	...
	/**
	 * 主要功能： 主要算法： 异常描述： 创建日期：(2001-8-8 11:45:58) 最后修改日期：(2001-8-8 11:45:58)
	 *
	 * @author：wyan
	 * @return java.lang.String
	 */
	...
	/**
	 * 主要功能： 主要算法： 异常描述： 创建日期：(2001-8-8 11:46:28) 最后修改日期：(2001-8-8 11:46:28)
	 *
	 * @author：wyan
	 * @return java.lang.String
	 */
	...
	/**
	 * 主要功能： 主要算法： 异常描述： 创建日期：(2001-8-8 10:25:02) 最后修改日期：(2001-8-8 10:25:02)
	 *
	 * @author：wyan
	 * @return java.lang.String[]
	 */
	...
	/**
	 * 主要功能： 主要算法： 异常描述： 创建日期：(2001-8-10 13:55:24) 最后修改日期：(2001-8-10 13:55:24)
	 *
	 * @author：wyan
	 * @return java.lang.String
	 */
	...
	/**
	 * 此处插入方法说明。 创建日期：(2002-7-3 15:33:19)
	 *
	 * @return java.lang.String
	 */
	...
	/**
	 * 主要功能： 主要算法： 异常描述： 创建日期：(2001-8-10 18:42:43) 最后修改日期：(2001-8-10 18:42:43)
	 *
	 * @author：wyan
	 * @return java.lang.String
	 */
	...
	/**
	 * 主要功能： 主要算法： 异常描述： 创建日期：(2001-8-8 11:52:50) 最后修改日期：(2001-8-8 11:52:50)
	 *
	 * @author：wyan
	...
	/**
	 * 主要功能： 主要算法： 异常描述： 创建日期：(2001-8-8 11:02:09) 最后修改日期：(2001-8-8 11:02:09)
	 *
	 * @author：wyan
	 * @param bzbm
	 *            java.lang.String
	...
	/**
	 * 主要功能： 主要算法： 异常描述： 创建日期：(2001-8-8 11:13:09) 最后修改日期：(2001-8-8 11:13:09)
	 *
	 * @author：wyan
	 * @param bzmc
	 *            java.lang.String
	...
	/**
	 * 此处插入方法描述。 创建日期：(2003-9-29 13:29:07)
	 *
	 * @param ce
	...
	/**
	 * 主要功能： 主要算法： 异常描述： 创建日期：(2001-8-8 10:26:41) 最后修改日期：(2001-8-8 10:26:41)
	 *
	 * @author：wyan
	 * @param date
	 *            java.lang.String
	...
	/**
	 * 主要功能： 主要算法： 异常描述： 创建日期：(2001-8-10 14:02:47) 最后修改日期：(2001-8-10 14:02:47)
	 *
	 * @author：wyan
	 * @param qj
	 *            java.lang.String
	...
	/**
	 * 主要功能： 主要算法： 异常描述： 创建日期：(2001-8-10 15:33:22) 最后修改日期：(2001-8-10 15:33:22)
	 *
	 * @author：wyan
	 * @param clbh
	 *            java.lang.String
	...
	/**
	 * 主要功能： 主要算法： 异常描述： 创建日期：(2001-8-10 14:10:30) 最后修改日期：(2001-8-10 14:10:30)
	 *
	 * @author：wyan
	 * @param currency
	 *            java.lang.String
	...
	/**
	 * 主要功能： 主要算法： 异常描述： 创建日期：(2001-8-10 14:09:15) 最后修改日期：(2001-8-10 14:09:15)
	 *
	 * @author：wyan
	 * @param datebeg
	 *            java.lang.String
	...
	/**
	 * 主要功能： 主要算法： 异常描述： 创建日期：(2001-8-10 14:09:53) 最后修改日期：(2001-8-10 14:09:53)
	 *
	 * @author：wyan
	 * @param dateEnd
	 *            java.lang.String
	...
	/**
	 * 主要功能： 主要算法： 异常描述： 创建日期：(2001-8-10 14:05:33) 最后修改日期：(2001-8-10 14:05:33)
	 *
	 * @author：wyan
	 * @param custcode
	 *            java.lang.String
	...
	/**
	 * 主要功能： 主要算法： 异常描述： 创建日期：(2001-8-8 11:01:05) 最后修改日期：(2001-8-8 11:01:05)
	 *
	 * @author：wyan
	 * @param dwbm
	 *            java.lang.String
	...
	/**
	 * a功能: 作者：wyan 创建时间：(2002-5-14 11:26:04) 参数：<|> 返回值： 算法：
	 *
	 * @param fbpk
	 *            java.lang.String
	 */
	...
	/**
	 * 此处插入方法说明。 创建日期：(2001-11-6 16:52:01)
	 *
	 * @param mode
	 *            boolean
	 */
	...
	/**
	 * 主要功能： 主要算法： 异常描述： 创建日期：(2001-8-8 10:25:53) 最后修改日期：(2001-8-8 10:25:53)
	 *
	 * @author：wyan
	 * @param date
	...
	/**
	 * a功能: 作者：wyan 创建时间：(2002-5-14 11:26:46) 参数：<|> 返回值： 算法：
	 *
	 * @param Bbpk
	 *            java.lang.String
	 */
	...
	/**
	 * 主要功能： 主要算法： 异常描述： 创建日期：(2001-8-10 14:11:52) 最后修改日期：(2001-8-10 14:11:52)
	 *
	 * @author：wyan
	 * @param maxje
	 *            java.lang.String
	...
	/**
	 * 主要功能： 主要算法： 异常描述： 创建日期：(2001-8-10 14:11:29) 最后修改日期：(2001-8-10 14:11:29)
	 *
	 * @author：wyan
	 * @param minje
	 *            java.lang.String
	...
	/**
	 * 主要功能： 主要算法： 异常描述： 创建日期：(2001-8-10 16:23:00) 最后修改日期：(2001-8-10 16:23:00)
	 *
	 * @author：wyan
	 * @param mode
	 *            java.lang.String
	...
	/**
	 * 此处插入方法描述。 创建日期：(2003-9-28 13:50:39)
	 *
	 * @param accids
	 *            java.util.Hashtable
	 */
	...
	/**
	 * 主要功能： 主要算法： 异常描述： 创建日期：(2001-8-8 11:47:47) 最后修改日期：(2001-8-8 11:47:47)
	 *
	 * @author：wyan
	 * @param begDate
	 *            java.lang.String
	...
	/**
	 * 主要功能： 主要算法： 异常描述： 创建日期：(2001-8-8 11:47:22) 最后修改日期：(2001-8-8 11:47:22)
	 *
	 * @author：wyan
	 * @param endDate
	 *            java.lang.String
	...
	/**
	 * 主要功能： 主要算法： 异常描述： 创建日期：(2001-8-8 10:24:44) 最后修改日期：(2001-8-8 10:24:44)
	 *
	 * @author：wyan
	 * @param bzbms
	 *            java.lang.String[]
	...
	/**
	 * 主要功能： 主要算法： 异常描述： 创建日期：(2001-8-10 13:55:06) 最后修改日期：(2001-8-10 13:55:06)
	 *
	 * @author：wyan
	 * @param sfbz
	 *            java.lang.String
	...
	/**
	 * 此处插入方法说明。 创建日期：(2002-7-3 15:32:56)
	 *
	 * @param sign
	 *            java.lang.String
	 */
	...
	/**
	 * 主要功能： 主要算法： 异常描述： 创建日期：(2001-8-10 18:43:08) 最后修改日期：(2001-8-10 18:43:08)
	 *
	 * @author：wyan
	 * @param user
	 *            java.lang.String
	...
	/**
	 * 主要功能： 主要算法： 异常描述： 创建日期：(2001-8-8 11:52:30) 最后修改日期：(2001-8-8 11:52:30)
	 *
	 * @author：wyan
	 * @param xzbz
	 *            java.lang.Boolean
