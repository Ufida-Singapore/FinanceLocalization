 ...
 */
public class GatherEntryShowChgAction extends NCAction {
	...
	Map<String, String> issummaryMap = new HashMap<String, String>();
	 ...
	 * 构造方法
	 */
	public GatherEntryShowChgAction() {
		super();
		setBtnName(summary)/* 合并显示 */;
		putValue(INCAction.CODE, IPrintActionCode.DETAILSDISPLAY);
	}
