...
public class paystatement_config extends AbstractJavaBeanDefinition{
...
public nc.ui.arap.recpaystatement.action.ArapPayStatementQueryAction getQueryAction(){
 if(context.get("queryAction")!=null)
 return (nc.ui.arap.recpaystatement.action.ArapPayStatementQueryAction)context.get("queryAction");
  nc.ui.arap.recpaystatement.action.ArapPayStatementQueryAction bean = new nc.ui.arap.recpaystatement.action.ArapPayStatementQueryAction();
